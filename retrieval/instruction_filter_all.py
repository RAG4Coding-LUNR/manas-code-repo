...
def filter_python_code(input_file, output_file):
    """
    Reads a CSV, extracts ALL code blocks from the 'Target' column,
    and saves the result along with 'Prompt' and 'Dataset Name' to a new CSV.
    Skips rows that do not contain a code block.
    """
...
output_csv = '/home/avisingh/datasets/instruction_filtered_all.csv'

# Run the function
filter_python_code(input_csv, output_csv)

# Filtered Dataset Size: 465128