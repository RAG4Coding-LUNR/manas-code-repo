...
trainer = SFTTrainer(
    ...
    args=TrainingArguments(
        learning_rate=2e-5, # Learning rate is set to 1e-4, changing it to 2e-5 to see if it helps with overfitting
        ...
        num_train_epochs=1, # Number of training epochs is set to 3, changing it to 1 to see if it helps with overfitting
